...
RSpec.describe Agents::RunContext::Usage do
  ...
  let(:usage_struct) { Struct.new(:tokens) }
  ...
  describe "#add" do
    context "with valid usage object" do
      let(:llm_usage) { usage_struct.new(RubyLLM::Tokens.new(input: 100, output: 50)) }
    ...
    context "with nil values" do
      ...
      it "handles partial nil values" do
        partial_usage = usage_struct.new(RubyLLM::Tokens.new(input: 50))
